...
namespace smartcity.Library
{
  ...
  /// <summary>
    ...
    {
        private static string ConnectionString = @"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\jay\Documents\smartCityMain.mdf;Integrated Security=True;Connect Timeout=30";
