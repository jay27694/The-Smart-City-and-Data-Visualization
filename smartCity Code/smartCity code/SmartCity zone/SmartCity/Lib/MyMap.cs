...
namespace map
{
    ...
    public class MyMap
    {
       ...
       // private Route route;
        ...
        public void addNewPolygon(LocationCollection l)
        {
        ...
        public void addNewPolygonRed(LocationCollection l)
        {
            MapPolygon polygon = new MapPolygon();
        ...
        public void addNewPolygonGreen(LocationCollection l)
        {
            MapPolygon polygon = new MapPolygon();
        ...
        public void addNewPolygonOrange(LocationCollection l)
        {
            MapPolygon polygon = new MapPolygon();
        ...
        //draggable pushpn
        public void AddDraggablePushin(Location location)
        {
    ...
    //new draggable pushpn class library from:  http://code.msdn.microsoft.com/bing/Draggable-Pushpins-in-Bing-48cb2683/sourcecode?fileId=95864&pathId=1786495714
